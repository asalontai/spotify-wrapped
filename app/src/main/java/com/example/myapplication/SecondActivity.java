...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyWrapsActivity.imageClick(image3, 1);
                ...
                for (DocumentSnapshot document : queryDocumentSnapshots.getDocuments()) {
                    ...
                    if (dateStamp != null && dateStamp.equals(FirstActivity.wrapDate)) {
                        ...
                        if (wrapJson != null) {
                            ...
                            loadImage(trackImageUrls1[1], image3);
                            text3.setText(trackNames1[1]);
                            loadImage(artistImageUrls1[1], image4);
                            text4.setText(artistNames1[1]);
                        }
                    }
                }
